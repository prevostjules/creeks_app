...
file = URI.open('https://res.cloudinary.com/dvwipbafx/image/upload/v1593166799/Calvin_mis0ll.jpg')
...
file = URI.open('https://res.cloudinary.com/dvwipbafx/image/upload/v1593166799/Dylan_i9093x.jpg')
user = User.new(username:"Dylan", email:"dylan@gmail.com", password:"secret")
user.photo.attach(io: file, filename: 'bob.jpg', content_type: 'image/jpg')
user.save!

file = URI.open('https://res.cloudinary.com/dvwipbafx/image/upload/v1593166799/Charles_kor190.jpg')
...
file = URI.open('https://res.cloudinary.com/dvwipbafx/image/upload/v1593166799/Michel_ubqgyd.jpg')
...
file = URI.open('https://res.cloudinary.com/dvwipbafx/image/upload/v1593168931/fitness_dancing_xjzcxo.png')
...
file = URI.open('https://res.cloudinary.com/dvwipbafx/image/upload/v1593169070/Capture.png')
