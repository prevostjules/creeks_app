...
camille = User.new(username:"Camille", email:"camille@gmail.com", password:"secret", role: 1, description: "Je suis une excellente pédagogue et possède une très bonne expérience de la transmission des compétences dans cette matière.")
...
anna = User.new(username:"Anna", email:"anna@gmail.com", password:"secret", role: 1, description: "Avec moi, l'essayer c'est l'adopter !")
...
kevin = User.new(username:"Kevin", email:"kevin@gmail.com", password:"secret", role: 1, description: "Je suis professeur depuis 15 ans, grand passionné de ma discipline !")
...
emma = User.new(username:"Emma", email:"emma@gmail.com", password:"secret", role: 1, description: "Je suis passionnée par le yoga depuis toujours, j'ai eu la chance de rencontrer les plus grands yogi de tous les temps !")
...
file = URI.open('https://res.cloudinary.com/dvwipbafx/image/upload/v1593004241/4_hv3onf.jpg')
...
file = URI.open('https://res.cloudinary.com/dvwipbafx/image/upload/v1593174145/camille2_op3dnx.jpg')
...
file = URI.open('https://res.cloudinary.com/dvwipbafx/image/upload/v1593175231/11_nmkmvc.jpg')
